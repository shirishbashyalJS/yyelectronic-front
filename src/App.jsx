...
// //   const orderGetRequest = (contact) => {
// //     axios
// //       .get(`${baseURL}order`, { headers: contact })
// //       .then((res) => setOrdered(res.data[0].orderItems))
// //       .catch((err) => {
// //         if (err.response?.status === 404) {
// //           console.log("No orders found for this user.");
// //           setOrdered([]); // or show empty cart
// //         } else {
...
// //     if (!manualLocation || (latitude === null && longitude === null)) {
// //       alert("Location is required before confirming.");
// //       return;
// //     }

// //     const orderItem = { img, name, category, quantity, rate, discount, total };
// //     const userDetails = { latitude, longitude, manualLocation, phone };

// //     axios
// //       .post(`${baseURL}order`, { orderItem, userDetails })
// //       .then(() => {
// //         setOrdered((prev) => [...prev, pendingOrder]);
// //         setSuccess(true);
...
//       const docs = res.data; // array of order documents

//       // Option A: if you only ever store one order doc per user:
//       if (Array.isArray(docs) && docs.length > 0 && docs[0].orderItems) {
//         setOrdered(docs[0].orderItems);
//       } else {
//         // no orders found → empty cart
//         setOrdered([]);
//       }

//       // Option B: if you might have multiple order docs and want all items:
//       // const allItems = Array.isArray(docs)
//       //   ? docs.flatMap(doc => doc.orderItems || [])
//       //   : [];
//       // setOrdered(allItems);
//     } catch (err) {
//       if (err.response?.status === 404) {
